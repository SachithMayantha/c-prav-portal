                  ...
                  <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item" role="presentation">
                        <a class="nav-link" id="home-tab" data-bs-toggle="tab" href="#home-1" role="tab" aria-controls="home" aria-selected="false" tabindex="-1">Product Info</a>
                      </li>
                      <li class="nav-item" role="presentation">
                                ...
                                <div class="card mb-3" style={{ border: '1px solid #dbdbd9' }}>
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-xl-9"><select class="form-control" id="customer" name="customer"></select></div>
                                    </div>
                                    ...
                                    <div class="card">
                                      ...
                                      <div class="card-body">
                                        <div class="form-group row mb-1">
                                          <div class="col-xl-12 col-lg-12"><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="1" type="checkbox" name="frequencies[]" value="1" />    <label for="1" class="mr-1">125 kHz: Immobiliser</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="2" type="checkbox" name="frequencies[]" value="2" />    <label for="2" class="mr-1">13,56 MHz: NFC</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="3" type="checkbox" name="frequencies[]" value="3" />    <label for="3" class="mr-1">315 MHz: SRD</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="4" type="checkbox" name="frequencies[]" value="4" />    <label for="4" class="mr-1">433 MHz: SRD</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="5" type="checkbox" name="frequencies[]" value="5" />    <label for="5" class="mr-1">868 MHz: SRD</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="15" type="checkbox" name="frequencies[]" value="15" />    <label for="15" class="mr-1">868 MHz: RFID</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="12" type="checkbox" name="frequencies[]" value="12" />    <label for="12" class="mr-1">920 MHz: RFID</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="16" type="checkbox" name="frequencies[]" value="16" />    <label for="16" class="mr-1">920 MHz: SRD</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="7" type="checkbox" name="frequencies[]" value="7" />    <label for="7" class="mr-1">2,4 GHz: BT</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="13" type="checkbox" name="frequencies[]" value="13" />    <label for="13" class="mr-1">2,4 GHz: WLAN</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="33" type="checkbox" name="frequencies[]" value="33" />    <label for="33" class="mr-1">2,4 Ghz: ISM PP</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="8" type="checkbox" name="frequencies[]" value="8" />    <label for="8" class="mr-1">5 GHz: WLAN Master</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="14" type="checkbox" name="frequencies[]" value="14" />    <label for="14" class="mr-1">5 GHz: WLAN Client</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="17" type="checkbox" name="frequencies[]" value="17" />    <label for="17" class="mr-1">Receiver: Rx only</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="9" type="checkbox" name="frequencies[]" value="9" />    <label for="9" class="mr-1">24 GHz: Radar</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="18" type="checkbox" name="frequencies[]" value="18" />    <label for="18" class="mr-1">24 GHz UWB: Radar</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="19" type="checkbox" name="frequencies[]" value="19" />    <label for="19" class="mr-1">60 GHz: Radar</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="10" type="checkbox" name="frequencies[]" value="10" />    <label for="10" class="mr-1">76-77 GHz: Radar</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="23" type="checkbox" name="frequencies[]" value="23" />    <label for="23" class="mr-1">77-81 GHz: Radar</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="11" type="checkbox" name="frequencies[]" value="11" />    <label for="11" class="mr-1">120 GHz: Radar</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="20" type="checkbox" name="frequencies[]" value="20" />    <label for="20" class="mr-1">600-900 MHz: 5G Low-Band </label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="26" type="checkbox" name="frequencies[]" value="26" />    <label for="26" class="mr-1">1-6 GHz: 5G Mid-Band</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="27" type="checkbox" name="frequencies[]" value="27" />    <label for="27" class="mr-1">24-40 GHz: 5G High-Band </label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="28" type="checkbox" name="frequencies[]" value="28" />    <label for="28" class="mr-1">450-900 MHz: 4G LTE Low-Band </label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="29" type="checkbox" name="frequencies[]" value="29" />    <label for="29" class="mr-1">1-3 GHz: 4G LTE Mid-Band</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="30" type="checkbox" name="frequencies[]" value="30" />    <label for="30" class="mr-1">3-4 GHz: 4G LTE High-Band </label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="21" type="checkbox" name="frequencies[]" value="21" />    <label for="21" class="mr-1">800-960 MHz: 3G UMTS</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="31" type="checkbox" name="frequencies[]" value="31" />    <label for="31" class="mr-1">1,5-2,2 GHz: 3G UMTS</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="22" type="checkbox" name="frequencies[]" value="22" />    <label for="22" class="mr-1">6-9 GHz: UWB</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="24" type="checkbox" name="frequencies[]" value="24" />    <label for="24" class="mr-1">125 kHz: WPT</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="25" type="checkbox" name="frequencies[]" value="25" />    <label for="25" class="mr-1">360 kHz: WPT</label></div><div class="mr-3 float-left bg-gray-100 pl-1 pr-1 mb-1">    <input id="32" type="checkbox" name="frequencies[]" value="32" />    <label for="32" class="mr-1">1-2 GHz: GNSS (Rx only)</label></div></div>                                    </div>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="card-footer text-right">
